...
$cms_lang['mod_config_save']			= 'Modulkonfiguration behalten';
$cms_lang['mod_update_save']			= 'Modul aktualisieren';
$cms_lang['mod_reinstall_save']		= 'Modul reinstallieren';
$cms_lang['mod_config_change']			= 'Modulkonfiguration &auml;ndern';
...
$cms_lang['mod_upload']				= 'Modul hochladen';
...
$cms_lang['mod_repository_upload']		= 'Modul in Repository hochladen';
$cms_lang['mod_repository_update']		= 'Modul aus Repository aktualisieren';
$cms_lang['mod_repository_use_dev']	= 'Developer-Module aus Repository nutzen';
$cms_lang['mod_repository_noupdate']	= 'Modul ist aktuell';
$cms_lang['mod_repository_notonline']	= 'Repository nicht erreichbar';
$cms_lang['mod_local_update']	     	= 'Modul aktualisieren';
$cms_lang['mod_database']				= 'Modul-Datenbank';
$cms_lang['mod_repository_download']	= 'Modul aus Repository herunterladen';
...
$cms_lang['mod_confirm_update_config'] = 'Modulkonfiguration aktualisieren und in allen Templates/Ordnern/Seiten zur&uuml;cksetzen?';
$cms_lang['mod_confirm_reinstall']	    = '<h5>Das Modul ist schon vorhanden!</h5><p>Welche Module sollen reinstalliert werden?</p>';
$cms_lang['mod_confirm_update']	    = '<h5>Es wurde ein Update gefunden!</h5><p>Welche Module sollen aktualisiert werden?</p>';
$cms_lang['mod_confirm_lupdate']	    = '<h5>Es wurde ein Update gestartet!</h5><p>Wie soll das Module aktualisiert werden?</p>';
...
$cms_lang['err_0405']					= 'Modul wurde erfolgreich vom Repository aktualisiert.';
...
$cms_lang['err_0415']					= 'Modul wurde erfolgreich aktualisiert.';
$cms_lang['err_0416']					= 'Fehler im Modul-%s, Zeile: <b>%s</b>';
$cms_lang['err_0417']					= 'Aktualisierung l&auml;uft';
$cms_lang['err_0418']					= 'Aktion abgebrochen';
$cms_lang['err_0419']					= 'Reinstallation l&auml;uft';
$cms_lang['err_0420']					= 'Module erfolgreich aktualisiert.';
$cms_lang['err_0421']					= 'Module erfolgreich reinstalliert.';
$cms_lang['err_0422']					= 'Module erfolgreich aktualisiert & reinstalliert.';
