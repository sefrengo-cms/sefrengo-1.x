...
echo "    <table class=\"config\" cellspacing=\"1\">\n";
	...
	echo "        <input type='button' name='sf_cancel' title='".$cms_lang['gen_cancel_titletext']."' value='".$cms_lang['gen_cancel']."' class=\"sf_buttonActionCancel\" onclick=\"window.location='".$sess->url("main.php?area=plug&idclient=$idclient")."'\"/>\n";
	echo "        </td>\n";
	echo "      </tr>\n";    
