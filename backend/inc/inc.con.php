...
if ($action && $view && $perm->have_perm(3, 'area_frontend', 3) ) {
	switch($action) {
		case 'side_delete':  // Seite l�schen
...
switch($action) {
	...
	case 'side_visible':  // Seite online/offline schalten
		...
		break;
	case 'delete_cache':  // Cache l�schen
